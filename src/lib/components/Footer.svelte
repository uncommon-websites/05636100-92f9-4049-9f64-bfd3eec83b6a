        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24">
            ...
            <div class="lg:col-span-5">
                <div class="flex items-center gap-2 mb-8">
                    ...
                    <span class="text-xl font-semibold tracking-tight">Motherline Institute</span>
                </div>
                
                <h3 class="text-2xl md:text-[28px] font-medium leading-tight mb-8 max-w-md tracking-tight">
                    Delivering <span class="font-serif italic">whole-person postpartum care</span><br/> through multidisciplinary expertise<br/> and evidence-based protocols.
                </h3>
                
                <div class="mb-4">
                    <p class="text-[11px] font-bold uppercase tracking-widest opacity-60 mb-2">
                        Postpartum care insights for your inbox.
                    </p>
                    <p class="text-[11px] opacity-40 mb-6 font-light">
                        By signing up you consent to receive Motherline Institute emails.
                    </p>
                    
                    <form class="flex items-center border border-white/20 rounded-full p-1 max-w-sm hover:border-white/40 transition-colors">
                        <input type="email" placeholder="Sign Up For Our Newsletter" class="bg-transparent text-white text-[11px] px-6 py-3 flex-grow outline-none placeholder-white/40 tracking-wide uppercase font-bold" />
                        <button type="submit" class="w-10 h-10 flex items-center justify-center text-white hover:opacity-70 transition-opacity">
                            →
                        </button>
                    </form>
                </div>
                ...
                <p class="text-[9px] opacity-30 mt-8 max-w-xs leading-relaxed">
                    Motherline Institute provides healthcare services and education. Individual results may vary. Consult with your healthcare provider for personalized medical advice.
                </p>
            </div>
            ...
            <div class="lg:col-span-7 grid grid-cols-2 md:grid-cols-4 gap-8">
                <!-- Column 1 -->
                <div>
                    <h4 class="text-[10px] font-bold uppercase tracking-widest opacity-40 mb-6">Programs</h4>
                    <ul class="space-y-3 text-[13px] font-medium">
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Postpartum Care</a></li>
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Mental Health</a></li>
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Digital Education</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-[13px] font-medium">
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Our Approach</a></li>
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Care Team</a></li>
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Clinical Protocols</a></li>
                    </ul>
                    ...
                    <ul class="space-y-3 text-[13px] font-medium">
                        ...
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Facebook</a></li>
                ...
                <!-- Column 3 -->
                <div>
                    <h4 class="text-[10px] font-bold uppercase tracking-widest opacity-40 mb-6">Partnerships</h4>
                    <ul class="space-y-3 text-[13px] font-medium">
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Hospitals</a></li>
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Providers</a></li>
                    ...
                    <ul class="space-y-3 text-[13px] font-medium">
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Terms of Service</a></li>
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Privacy Policy</a></li>
                        <li><a href="/" class="hover:opacity-70 transition-opacity">HIPAA Notice</a></li>
                ...
                <!-- Column 4 -->
                <div>
                    <h4 class="text-[10px] font-bold uppercase tracking-widest opacity-40 mb-6">Support</h4>
                    <ul class="space-y-3 text-[13px] font-medium">
                        ...
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Patient Portal</a></li>
                        <li><a href="/" class="hover:opacity-70 transition-opacity">Insurance</a></li>
        ...
        <div class="border-t border-white/10 pt-12 pb-12 relative">
             <div class="w-full flex justify-center">
                 ...
                 <svg viewBox="0 0 1000 200" class="w-full max-w-6xl text-[#F4F4F0] opacity-90 fill-current">
                     ...
                     <text x="500" y="150" text-anchor="middle" font-family="serif" font-style="italic" font-size="100" font-weight="bold" letter-spacing="-3">Care for Every Mother</text>
                 </svg>
             </div>
        </div>
        
        <div class="text-center text-[10px] opacity-30 font-medium tracking-wide">
            © 2025 Motherline Institute
        </div>
    </div>
</footer>
